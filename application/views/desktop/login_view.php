...
<div style="width:250px;background:#ffffff;padding:5px;">	<center>	<img src="<?php echo base_url();?>logo/<?php echo $logo; ?>" title="Logo"></center>
<br>
<br>
...
<span style="float:left;margin-left:20px;">Login </span><?php
...
<center>
 ...
 <div style="padding:5px;width:239px;height:38px;background-image:url('<?php echo  base_url('images/login_email.png');?>');">    <input type="text"  id="username" name="username" placeholder=" Username" autocomplete="off" style="border:0px;height:20px;width:180px;float:right;margin-top:5px;margin-right:5px;"/></div>
