...
if($key >="1"){
?>
<a href="#"   class="button-success pure-button" style="cursor:pointer;"  onClick="showquestion('<?php echo $key-1;?>','<?php echo $question['q_type'];?>');" >Back</a>
<?php
}
...
$category_number+=1;
?>
<a href="#"   class="button-success pure-button" style="cursor:pointer;"  onClick="showquestion('<?php echo $key+1;?>','<?php echo $question['q_type'];?>');changecategory('<?php echo $category_number;?>');update_curr_ans('<?php echo $key;?>','<?php echo $question['q_type'];?>');" > Save & Next</a>
<?php
}else{
?>
<a href="#"   class="button-success pure-button" style="cursor:pointer;"  onClick="showquestion('<?php echo $key+1;?>','<?php echo $question['q_type'];?>');update_curr_ans('<?php echo $key;?>','<?php echo $question['q_type'];?>');" > Save & Next</a>
<?php
}
}
?>
&nbsp; 
<a href="#"   class="button-success pure-button" style="cursor:pointer;background:#9052ac"  onClick="reviewlater('<?php echo $question['q_type'];?>');"> Review later </a>
&nbsp; 
<a href="#"   class="button-success pure-button" style="cursor:pointer;"  onClick="clearresponse('<?php echo $key;?>');" > Clear-Response </a>
&nbsp; <?php if ($result->pract_test=="0"){ ?><a href="javascript:pre_sbtform();"   class="button-error pure-button" style="cursor:pointer;">Submit Test</a><?php }else{ ?> <a href="javascript:close_practice();"   class="button-error pure-button" style="cursor:pointer;">Close</a> <?php } ?>
</td></tr>
...
$category_number+=1;
?>
<a href="#"   class="button-success pure-button" style="cursor:pointer;"  onClick="showquestion('<?php echo $key+1;?>','<?php echo $question['q_type'];?>');changecategory('<?php echo $category_number;?>');update_curr_ans('<?php echo $key;?>','<?php echo $question['q_type'];?>','<?php echo $question['qid'];?>');" >Save & Next</a>
<?php
}else{
?>
<a href="#"   class="button-success pure-button" style="cursor:pointer;"  onClick="showquestion('<?php echo $key+1;?>','<?php echo $question['q_type'];?>');update_curr_ans('<?php echo $key;?>','<?php echo $question['q_type'];?>','<?php echo $question['qid'];?>');" >Save & Next</a>
<?php
}
}
?>
...
<div id="left_div" style="padding:10px; width:22%;height:480px; border:1px solid #dddddd;margin-left:0px;margin-top:36px;">
Questions<br>
...
<br> <table>
<tr><td style="font-size:10px;"><div class="count_btn" style="background:#267B02;width:5px;height:5px;">&nbsp;</div> Answered</td></tr>
<tr><td style="font-size:10px;"><div class="count_btn" style="background:#D03800;width:5px;height:5px;">&nbsp;</div> UnAnswered</td></tr>
<tr><td style="font-size:10px;"><div class="count_btn" style="background:#FFD800;width:5px;height:5px;">&nbsp;</div> Review-Later</td></tr>
<tr><td style="font-size:10px;"><div class="count_btn" style="background:#212121;width:5px;height:5px;">&nbsp;</div> Not-visited</td></tr>
</table>
<br><br>
</div>
<div style="clear:both"></div>
...
<a href="javascript:pre_sbtform();"   class="button-success pure-button" style="cursor:pointer;">Cancel</a> &nbsp; &nbsp; &nbsp; &nbsp;
<a href="javascript:sbtform();"   class="button-error pure-button" style="cursor:pointer;">Submit Quiz</a>
