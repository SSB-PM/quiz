...
<a href="<?php echo site_url('result/view/'.$id);?>"  class="button-error pure-button">Back</a>
<br>
<div class="wite">
<div  id="left_div">
<?php 
...
<input type="button" value="ADD SCORE"  onClick="add_score('<?php echo $question['qid'];?>','<?php echo $id;?>','<?php echo $essay_ans;?>');" class="button-warning pure-button">	
<?php	
}
	}
?>
...
foreach($assigned_question[0] as $key => $question){
?>
<div class="count_btn" onClick="showquestion_afterquiz('<?php echo $key;?>');"   <?php   if($correct_incorrect[$key]>="0.1"){ ?> style="background:#267B02;"  <?php }else if($correct_incorrect[$key]==0 && $oidss[$key]!=0 ){ ?>style="background:#D03800;"    <?php }  ?> ><?php echo $key+1;?></div>
<?php
}
?>
</div>
